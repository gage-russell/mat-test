classdef xExtender < handle
    ...
    methods (Hidden)
        ...
        function [nname, npath] = cloneclass(obj, classname, sourcedir, prename)
            ...
            obj.txtrep(npath, "obj.ext = xExtender", "obj.ext = " + obj.getvalidname + "Extender");
            obj.txtrep(npath, "upd = xUpdater", "upd = " + obj.getvalidname + "Updater");
        end
